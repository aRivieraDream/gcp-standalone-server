...
printf "Login credentials can be found in the secrets file. If you are running this for the first time, download the screts file from https://console.cloud.google.com/storage/browser/tslinux-silent-install/static-assets"
